    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, to='events.Location', null=True, on_delete=models.PROTECT)),
            ],
            options={
                'ordering': ('-datetime',),
            },
        ...
        migrations.AddField(
            ...
            name='email_to',
            field=models.ForeignKey(to='meetings.TargetEmailList', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='meetingannounce',
            name='events',
        ...
        migrations.AddField(
            model_name='meeting',
            name='meeting_type',
            field=models.ForeignKey(default=1, to='meetings.MeetingType', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='ccnoticesend',
            name='email_to',
            field=models.ForeignKey(default=meetings.models.get_default_email, to='meetings.TargetEmailList', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='ccnoticesend',
            name='events',
