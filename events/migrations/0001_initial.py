    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by',
                 models.ForeignKey(related_name='eventapprovals', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(to='events.Category', on_delete=models.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='ExtraInstance',
            fields=[
                ...
                ('extra', models.ForeignKey(to='events.Extra', on_delete=models.PROTECT)),
            ],
        ),
        migrations.CreateModel(
            name='Fund',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_in_charge', models.ForeignKey(related_name='orgowner', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT)),
            ],
            options={
                'ordering': ['name'],
                'verbose_name': 'Client',
        ...
        migrations.AddField(
            model_name='service',
            name='category',
            field=models.ForeignKey(to='events.Category', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='hours',
            name='service',
            field=models.ForeignKey(related_name='hours', blank=True, to='events.Service', null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='hours',
            name='user',
        ...
        migrations.AddField(
            ...
            name='service',
            field=models.ForeignKey(related_name='ccinstances', to='events.Service', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='eventccinstance',
            name='setup_location',
            field=models.ForeignKey(related_name='ccinstances', to='events.Location', on_delete=models.PROTECT),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='event',
            name='billing_org',
            field=models.ForeignKey(related_name='billedevents', blank=True, to='events.Organization', null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='event',
            name='cancelled_by',
        ...
        migrations.AddField(
            model_name='event',
            name='closed_by',
            field=models.ForeignKey(related_name='eventclosings', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='event',
            name='contact',
            field=models.ForeignKey(verbose_name='Contact', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='event',
            name='crew',
        ...
        migrations.AddField(
            model_name='event',
            name='location',
            field=models.ForeignKey(to='events.Location', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='event',
            name='org',
        ...
        migrations.AddField(
            model_name='event',
            name='setup_location',
            field=models.ForeignKey(related_name='setuplocation', blank=True, to='events.Location', null=True, on_delete=models.SET_NULL),
        ),
        migrations.AddField(
            model_name='event',
            name='submitted_by',
            field=models.ForeignKey(related_name='submitter', to=settings.AUTH_USER_MODEL, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='ccreport',
            name='event',
        ...
        migrations.AddField(
            model_name='event',
            name='lighting',
            field=models.ForeignKey(related_name='lighting', blank=True, to='events.Lighting', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='event',
            name='projection',
            field=models.ForeignKey(related_name='projection', blank=True, to='events.Projection', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='event',
            name='sound',
            field=models.ForeignKey(related_name='sound', blank=True, to='events.Sound', null=True, on_delete=models.PROTECT),
        ),
    ]
