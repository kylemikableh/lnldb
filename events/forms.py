...
class EventApprovalForm(forms.ModelForm):
    ...
    billing_org = AutoCompleteSelectField('Funds', required=False, label='Client to bill')
...
class EventReviewForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Field('billing_org'),
            HTML("<h5>If you'd like to override the billing fund, please search for it below</h5>"),
            Field('billing_fund'),
    ...
    billing_fund = AutoCompleteSelectField('Funds', required=False, label="")
