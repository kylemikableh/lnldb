...
class PitInstance(models.Model):
    projectionist = models.ForeignKey(Projectionist, related_name="pitinstances", on_delete=models.CASCADE)
    pit_level = models.ForeignKey(PITLevel, related_name="pitinstances", on_delete=models.PROTECT)
